...
export function ServicesSection() {
  return <section className="section-padding bg-sand/50">
      <div className="container mx-auto">
        ...
        duration: 0.6
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Vi erbjuder ett brett utbud av trädgårdstjänster för privatpersoner, företag och bostadsrättsföreningar.</p>
        </motion.div>
        ...
        margin: "-100px"
          ...
          {services.map(service => <motion.div key={service.title} variants={itemVariants} className="bg-background rounded-2xl p-6 shadow-card hover:shadow-elevated transition-shadow duration-300">
